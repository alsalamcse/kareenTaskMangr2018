...
import com.owayed.kareen.kareentaskmangr2018.MyPageFragments.WhoRequestFragment.OnListFragmentInteractionListener;
...
public class MyWhoRequestRecyclerViewAdapter extends RecyclerView.Adapter<MyWhoRequestRecyclerViewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_whorequest, parent, false);
